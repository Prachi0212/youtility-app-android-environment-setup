...
object EnergySharedPreference {
    private val PREFERENCE_NAME = "EnergySharedPreference"
    ...
    fun getListString(key: String): ArrayList<String> {
        return ArrayList(Arrays.asList(*TextUtils.split(sharedPreferences.getString(key, ""), "‚‗‚")))
    }
